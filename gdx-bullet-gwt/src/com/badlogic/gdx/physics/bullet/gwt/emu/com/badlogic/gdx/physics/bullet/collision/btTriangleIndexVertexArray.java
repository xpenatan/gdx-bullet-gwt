...
public class btTriangleIndexVertexArray extends btStridingMeshInterface 
{
	...
	private native JavaScriptObject createObj() /*-{
		var obj = new $wnd.Ammo.btTriangleIndexVertexArray();
		return obj;
	}-*/;
	...
	private native void internalAddIndexedMesh(btIndexedMesh mesh, int indexType) /*-{ 
		var arrayJS = this.@com.badlogic.gdx.physics.bullet.BulletBase::jsObject;
		var meshJS = mesh.@com.badlogic.gdx.physics.bullet.BulletBase::jsObject;
		arrayJS.addIndexedMesh(meshJS, indexType);
	}-*/;
}
