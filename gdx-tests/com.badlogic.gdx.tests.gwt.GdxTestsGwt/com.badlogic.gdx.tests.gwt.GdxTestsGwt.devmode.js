...
var __gwtModuleFunction = $wnd.com_badlogic_gdx_tests_gwt_GdxTestsGwt;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.com.badlogic.gdx.tests.gwt.GdxTestsGwt=");
    idx += (13 + "com.badlogic.gdx.tests.gwt.GdxTestsGwt".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=com.badlogic.gdx.tests.gwt.GdxTestsGwt-0.js
